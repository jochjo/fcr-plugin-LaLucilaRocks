...
public class LaLucilaRocks extends Service {

    private static final String TAG = LaLucilaRocks.class.getSimpleName();

    private static final String SERVER_URL = "http://www.lalucilarocks.com/es/comic/";
  // private static final String SERVER_URL_JSON = "info.0.json";
  // private static final String ONLINE_STORE_URL = "about:no-yet";
